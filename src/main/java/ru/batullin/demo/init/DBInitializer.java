package ru.batullin.demo.init;

import org.springframework.security.crypto.bcrypt.BCryptPasswordEncoder;
import org.springframework.stereotype.Component;
import ru.batullin.demo.model.Role;
import ru.batullin.demo.model.User;
import ru.batullin.demo.repository.RoleRepository;
import ru.batullin.demo.repository.UserRepository;
...
public class DBInitializer {
    ...
    public void createTestUsersWithRoles() {
        ...
        User user2 = new User
                ("admin@mail.ru", "Булат", "Батуллин", (byte) 27,
